#NCI109 -MxGNN
python -m train --bmname=NCI109 --method=MxGNN --assign-ratio 0.1 0.1 0.1 --hidden-dim 30 50 80 --output-dim 30 50 80 --cuda=0 --num-classes=2 --num-aspect=3 --multi-conv=1 --multi-pool=0 --max-nodes=100  --epochs=1000 --dropout=0.0 --batch-size=20 --lr=0.001
