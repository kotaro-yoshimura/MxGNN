#NCI109 -MxGNN
python -m train --bmname=NCI109 --method=MxGNN --assign-ratio 0.1 --hidden-dim 50 --output-dim 50 --cuda=0 --num-classes=2 --num-aspect=1 --multi-conv=1 --multi-pool=0 --max-nodes=100  --epochs=1000 --dropout=0.0 --batch-size=20 --lr=0.001
